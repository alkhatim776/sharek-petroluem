...
class loan_line_rs_rent(models.Model):
    ...
    amount_tax_signed = fields.Monetary(related='invoice_id.amount_tax_signed', readonly=True)
    amount_total_signed = fields.Monetary(related='invoice_id.amount_total_signed',  readonly=True)
    ...
    def make_invoice(self):
        for rec in self:
            ...
            inv_dict={'ref': rec.name, 'journal_id': journal.id,
                                     ...
                                     'building':rec.loan_id.building.id,
                                     'building_unit':rec.loan_id.building_unit.id,
